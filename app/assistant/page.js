  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <h1 className="text-3xl font-semibold text-white">Asistente express</h1>
        <p className="text-gray-300">Respuestas rápidas y consejos para entrevistas y eventos.</p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        {quickQuestions.map(question => (
          <motion.button
            ...
            className="px-3 py-2 rounded-xl bg-white/10 text-sm text-white border border-white/10 hover:border-mint/40"
          >
            {question}
          </motion.button>
        ))}
      ...
      <div id="assistant-scroll" className="rounded-3xl glass border border-white/10 p-4 h-[60vh] overflow-y-auto space-y-3 flex flex-col">
